...
import { CONCEPTS, INITIAL_DRAGG_SUBTRACT_LEVEL_TWO, RESULTS } from '../../utils/constants'
  ...
  return (
    <>
      <Banner
        ...
        icon="-"
        numberOne={RESULTS.res.lvlTwo.numberOne}
        numberTwo={RESULTS.res.lvlTwo.numberTwo}
        result={RESULTS.res.lvlTwo.result}
      />
      <Modal
