...
import { CONCEPTS, INITIAL_DRAGG_LVL_THREE, RESULTS } from '../../utils/constants'
  ...
  return (
    <>
      <Banner
        ...
        icon="+"
        numberOne={RESULTS.sum.lvlThree.numberOne}
        numberTwo={RESULTS.sum.lvlThree.numberTwo}
        result={RESULTS.sum.lvlThree.result}
      />
      <Modal
